...
class App extends Component {
  ...
  onFormSubmit(data) {
    ...
    if(this.state.isEditProduct){
      apiUrl = 'http://127.0.0.1:8000/employees/update';
    } else {
  ...
  editProduct = productId => {
    ...
    const apiUrl = 'http://127.0.0.1:8000/employees/' + productId;
    ...
    return (
      <div className="App">
        <Container>
          ...
          {!this.state.isAddProduct && <Button variant="primary" onClick={() => this.onCreate()}>Add Employee</Button>}
